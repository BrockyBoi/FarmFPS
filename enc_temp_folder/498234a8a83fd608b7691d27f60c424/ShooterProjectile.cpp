...
void AShooterProjectile::ModifyThroughChargingWeapon(float percentageCharged)
{
	SetActorScale3D(FVector::OneVector * ScaleMultiplierAtMaxCharge * percentageCharged);
}
