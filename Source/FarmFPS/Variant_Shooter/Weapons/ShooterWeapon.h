...
protected:
	...
	/** If true, this weapon will charge up a projectile before firing */
	UPROPERTY(EditAnywhere, Category = "Charging")
	bool bIsChargeableWeapon = false;

	/** The maximum time you can charge the wepaon before it automatically fires at full blast */
	UPROPERTY(EditAnywhere, Category = "Charging")
